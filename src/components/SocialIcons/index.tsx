...
/**
 * Brand social marks, shared by the footer and the contact page.
 *
 * These lived inside Footer/Component.tsx. The contact page needs the same set,
 * and eight hand-written SVGs are not something to keep two copies of — they
 * drift, and then the footer and the contact page show different logos.
 *
 * Each mark keeps its own brand colour, except the ones whose brand colour is
 * black (X, TikTok, GitHub); those inherit `fill-foreground` so they stay
 * visible in dark mode.
 */
export type IconProps = { size?: number; className?: string }


export const socialIcons: Record<SocialLink['icon'], React.FC<IconProps>> = {
