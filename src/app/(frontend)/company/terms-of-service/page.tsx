      ...
      <div className="container pb-24">
        <article className="prose prose-lg mx-auto max-w-4xl dark:prose-invert">
          ...
          <p>
            ...
            software) on Exceed Venture&apos;s website for personal, non-commercial transitory
          ...
          <p>
            ...
            integration, and marketing services. The specific terms for each service will be
          ...
          <p>
            ...
            is the property of Exceed Venture or its content suppliers and protected by intellectual
            property laws.
          </p>

          <h3>6. Limitation of Liability</h3>
          <p>
            In no event shall Exceed Venture or its suppliers be liable for any damages arising out
            of the use or inability to use the materials on Exceed Venture&apos;s website.
          </p>

          <h3>7. Modifications</h3>
          <p>
            Exceed Venture may revise these terms of service at any time without notice. By using
