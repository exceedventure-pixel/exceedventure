...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return generatePageMeta({
    ...
    fallbackDescription:
      'One excellent post a quarter builds nothing. Audiences and search engines both reward the businesses that turn up reliably, and neither notices the ones that do not.',
  })
}
  ...
  return (
    <ServiceDetail
      ...
      hero={{
        ...
        headline: 'Consistency beats brilliance ',
        headlineAccent: 'every time.',
        pain: 'One excellent post a quarter builds nothing.',
        symptoms: [
          'Content comes in bursts, then stops',
