...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return generatePageMeta({
    ...
    // Kept in the same voice as the H1 and pain line in src/config/services.ts.
    fallbackDescription:
      'Ads running, posts going out, spend approved every month — and nobody can say which of it actually brought a customer.',
  })
}
